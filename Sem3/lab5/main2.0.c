...
int main(){
    ...
    while(arg[0]  != 'q') {
        ...
        printf("Select an action.\n"
                ...
                "\t\t3x. Add element before 5;\n"
                "\t\t4x. Add element after g;\n"
                "\t\t5x. Add element before before last;\n"
                "\t\t6x. Add element before last;\n"
                "\t\t7. Add 3th element;\n"
                "\t\t8. Add 2th element;\n"
                "\t\t9x. Add element in end of list;\n"
                "\t\t0x. Add element to the begining of list;\n"
                "\t\tq - Exit\nEnter:");
        scanf("%1024s", arg);
        switch(arg[0]){
        case '1':
