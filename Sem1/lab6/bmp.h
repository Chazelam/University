...
typedef struct _bmp_image {
    ...
    bmp_pixel_array new_pixel_array;
} bmp_image;
...
/*
void bmp_gauss_blur(bmp_image image);

void bmp_motion_blur(bmp_image image);

void bmp_median_blur(bmp_image image);

void poster(bmp_image image);*/
